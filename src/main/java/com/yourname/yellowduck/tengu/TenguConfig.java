...
public final class TenguConfig {
    ...
    /** Boss 攻击动画片段：88~108 帧，约 0.67 秒。 */
    public static final int ATTACK_ANIMATION_TICKS = 14;
    ...
    public static final int TRUST_GAIN_SMALL = 5;
    public static final int TRUST_GAIN_LARGE = 10;
