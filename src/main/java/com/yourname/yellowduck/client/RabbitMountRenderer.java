...
@OnlyIn(Dist.CLIENT)
public class RabbitMountRenderer extends GltfEntityRenderer<RabbitMountEntity> {
    ...
    @Override
    public void render(RabbitMountEntity entity, float entityYaw, float partialTick,
