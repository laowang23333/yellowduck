...
public final class ModParticles {
    ...
    public static final DeferredRegister<ParticleType<?>> PARTICLES =
            DeferredRegister.<ParticleType<?>>create(ForgeRegistries.PARTICLE_TYPES, YellowDuckMod.MOD_ID);

    public static final RegistryObject<SimpleParticleType> SAKURA_FLAME = PARTICLES.register("sakura_flame", () -> new SimpleParticleType(true));
    public static final RegistryObject<SimpleParticleType> SAKURA_PETAL = PARTICLES.register("sakura_petal", () -> new SimpleParticleType(true));
    public static final RegistryObject<SimpleParticleType> SAKURA_MAGIC = PARTICLES.register("sakura_magic", () -> new SimpleParticleType(true));
    ...
    public static final RegistryObject<SimpleParticleType> SAKURA_BEAR_RAGE_GROUND_RING = PARTICLES.register("sakura_bear_rage_ground_ring", () -> new SimpleParticleType(true));
    ...
    public static final RegistryObject<SimpleParticleType> SILK_DARK_SMOKE = PARTICLES.register("silk_dark_smoke", () -> new SimpleParticleType(true));
    public static final RegistryObject<SimpleParticleType> SILK_FEATHER = PARTICLES.register("silk_feather", () -> new SimpleParticleType(true));
